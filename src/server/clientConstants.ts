...
/**
 * The subset of server config that is injected into the page and served at
 * `GET /config`.
 */
...
export type Limits = ClientConstants['LIMITS'];
export type WebUi = ClientConstants['WEB_UI'];
export type Defaults = ClientConstants['DEFAULTS'];
